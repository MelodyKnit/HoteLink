...
class BookingOrder(models.Model):
    ...
    status = models.CharField(max_length=32, choices=STATUS_CHOICES, default=STATUS_PENDING_PAYMENT, db_index=True)
    payment_status = models.CharField(max_length=32, choices=PAYMENT_STATUS_CHOICES, default=PAYMENT_UNPAID, db_index=True)
