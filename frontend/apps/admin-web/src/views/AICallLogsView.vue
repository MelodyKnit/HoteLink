            ...
            <td class="px-4 py-2.5 text-center">
              <span
                ...
                :class="{
                  ...
                  'bg-amber-100 text-amber-700': log.status === 'timeout',
                  'bg-orange-100 text-orange-700': log.status === 'quota_exceeded',
                }"
              >
...
import { PageHeader, SelectField, Pagination } from '@hotelink/ui'
...
async function loadStats() {
  try {
    ...
    if (res.code === 0 && res.data) stats.value = res.data as StatsData
  } catch { /* silent */ }
}
